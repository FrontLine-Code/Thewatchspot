...
function renderImages(images) {
  ...
  images.map(function (image) {
    ...
    divElement.classList.add("border", "border-white", "hover:border-silver", "transition-[0.1s]", "border-white", "cursor-pointer", "bg-milk", "rounded-lg", "p-4", "flex", "flex-col");
    btnElement.classList.add("bg-darkgreen", "border", "border-darkgreen", "hover:bg-milk", "hover:text-darkgreen", "transition-colors", "text-white", "rounded-md", "pt-5", "pb-4", "px-8");
